  ...
  <div class="card">
    <div class="card-body">
      <form class="form" id="task-form">
        <p class="title">Ingrese la tarea <?php echo $varsesion; ?> </p>

        <div id="myElement" data-nombre="<?php echo $varsesion; ?>"></div>

        <div class="flex">
          <label class="form-group">
            <input required="" type="text" id="name" placeholder="Nombre" class="input1" class="form-control">
          </label>
          <label class="form-group">
